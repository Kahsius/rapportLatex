...
\begin{document}
	...
	\begin{center}
		\begin{tabular}{|l|c|c|c|}
			...
			\hline
		\end{tabular}
		\captionof{table}{Proportion of each class in the missclassification set}
	\end{center}
	\vspace{0.5cm}
	...
	\begin{center}
		\begin{tabular}{|l|c|c|c|}
			...
			\hline
		\end{tabular}
		\captionof{table}{Proportion of each class in the missclassification set with equalized database}
		\label{results}
	\end{center}
	\vspace{0.5cm}
